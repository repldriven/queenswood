...
jobs, webhooks and an operator console, all of it configured and driven through
one API. You bring the banking licence, the clearing partner and the identity
