(ns com.repldriven.queenswood.demo-digital-bank.platform-test
  (:require
    [com.repldriven.mono.migrator.interface]
    [com.repldriven.mono.testcontainers.interface]

    [com.repldriven.queenswood.demo-digital-bank.platform :as SUT]
...
(deftest token-cache-test
  (with-test-system
   [sys config]
   (let [client (system/instance sys [:demo-digital-bank :platform])
